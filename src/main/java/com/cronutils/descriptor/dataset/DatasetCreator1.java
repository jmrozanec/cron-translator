...
public class DatasetCreator1 {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        while(samples.size()<1000000){
            samples.add(createSample1());
            samples.add(createSample2());
            samples.add(createSample3());
            samples.add(createSample4());
            samples.add(createSample5());
            samples.add(createSample6());
