...
public class DatasetCreator3 {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        while(samples.size()<1000000){
            samples.add(simplifyRanges(createSample1()));
            samples.add(simplifyRanges(createSample2()));
            samples.add(simplifyRanges(createSample3()));
            samples.add(simplifyRanges(createSample4()));
            samples.add(simplifyRanges(createSample5()));
            samples.add(simplifyRanges(createSample6()));
            samples.add(simplifyRanges(createSample7()));
    ...
    private static String createSample1(){
        ...
        return entry
                .replaceAll("HOUR_KEY", hourk)
                .replaceAll("MONTH_KEY", monthk)
                .replaceAll("DOW_KEY", dowk)
                .replaceAll("DOWN_KEY", downk);
    }
    ...
    private static String createSample2(){
        ...
        return entry
                .replaceAll("HOUR_KEY", hourk)
                .replaceAll("YEAR_KEY", year)
                .replaceAll("DOY_KEY", downk);
    ...
    private static String createSample3(){
        Map<String, String> hour = hours();
        String hourk = randomKey(hour.keySet());
        String entry = "at HOUR_KEY | at HOUR_VAL";
        return entry.replaceAll("HOUR_KEY", hourk);
    }
    ...
    private static String createSample4(){
        ...
        String entry = "at HOUR_KEY every day between DOW_KEY1 and DOW_KEY2 | every day at HOUR_VAL between DOW_VAL and DOW_VAL";
        return entry
                .replaceAll("HOUR_KEY", hourk)
                .replaceAll("DOW_KEY1", dowk1)
                .replaceAll("DOW_KEY2", dowk2);
    }
    ...
    public static String createSample5(){
        ...
        String entry = "every second between 0 and 59 every minute between HOUR_KEY1 and HOUR_KEY2 every day between DOW_KEY1 and DOW_KEY2 | every minute between HOUR_VAL and HOUR_VAL between DOW_VAL and DOW_VAL";
        return entry
                .replaceAll("HOUR_KEY1", hourk1)
                .replaceAll("HOUR_KEY2", hourk2)
                .replaceAll("DOW_KEY1", dowk1)
                .replaceAll("DOW_KEY2", dowk2);
    }
    ...
    public static String createSample6(){
        Map<String, String> hour = hours();
        Set<String> dow = dow();
        String sec1 = randomMinute();
        String sec2 = randomMinute();
        while(sec1.equals(sec2)){
            sec2 = randomMinute();
        }
        String hourk1 = randomKey(hour.keySet());
        String hourk2 = randomKey(hour.keySet());
        ...
        String entry = "every second between SEC_KEY1 and SEC_KEY2 every minute between HOUR_KEY1 and HOUR_KEY2 every day between DOW_KEY1 and DOW_KEY2 | every second between SEC_VAL and SEC_VAL for every minute between HOUR_VAL and HOUR_VAL between DOW_VAL and DOW_VAL";
        return entry
                .replaceAll("SEC_KEY1", hourk1)
                .replaceAll("SEC_KEY2", hourk2)
                .replaceAll("HOUR_KEY1", hourk1)
                .replaceAll("HOUR_KEY2", hourk2)
                .replaceAll("DOW_KEY1", dowk1)
                .replaceAll("DOW_KEY2", dowk2);
    ...
    public static String createSample7(){
        Map<String, String> hour = hours();
        Set<String> dow = dow();
        ...
        String entry = "at MIN_KEY minute every hour between HOUR_KEY1 and HOUR_KEY2 every day between DOW_KEY1 and DOW_KEY2 | at minute MIN_VAL every day between DOW_VAL and DOW_VAL between HOUR_VAL and HOUR_VAL";
        return entry
                .replaceAll("MIN_KEY", minute)
                .replaceAll("HOUR_KEY1", hourk1)
                .replaceAll("HOUR_KEY2", hourk2)
                .replaceAll("DOW_KEY1", dowk1)
                .replaceAll("DOW_KEY2", dowk2);
    ...
    private static String simplifyRanges(String string){
        return string
                .replaceAll("every second between 0 and 59", "every second")
                .replaceAll("every minute between 0 and 59", "every minute")
                .replaceAll("every hour between 0 and 23", "every hour")
                .replaceAll("every second every minute", "every minute")
                .replaceAll("every minute every hour", "every hour");
    }
